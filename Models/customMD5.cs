...
namespace WebApplication1.Models
{
    ...
    public class customMD5
    {
        ...
        /*TODO:Custom method
        Somehow the transformation only runs one loop
        figure out how to visualise the information throughout the hash function.
        */
        ...
        figure out how to visualise the information throughout the hash function.
        */
        public String GetHashAtRound(uint a)
        {
            /***********vairable declaration**************/
            byte[] bMsg;    //buffer to hold bits
            uint N;         //N is the size of msg as  word (32 bit) 
            Digest dg = new Digest();           //  the value to be returned
            Digest temp = new Digest();
